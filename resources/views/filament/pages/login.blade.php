<div class="min-h-screen flex items-center justify-center bg-[#030712] font-sans text-slate-300">
    <div class="w-full max-w-md p-8 bg-[#111827] rounded-2xl shadow-2xl border border-white/5">
        ...
        <div class="text-center mb-8">
            <h1 class="text-2xl font-bold text-white">MostFinance</h1>
        ...
        <form wire:submit.prevent="login" class="space-y-6">
            <div>
                ...
                <input wire:model="email" type="email" class="w-full bg-[#1f2937] border border-slate-700 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-emerald-500 focus:outline-none transition">
            ...
            <div>
                ...
                <input wire:model="password" type="password" class="w-full bg-[#1f2937] border border-slate-700 rounded-lg px-4 py-2 text-white focus:ring-2 focus:ring-emerald-500 focus:outline-none transition">
            ...
            <button type="submit" class="w-full py-2.5 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold rounded-lg shadow-md transition-colors duration-200">
                Sign in
            </button>
        </form>

        <div class="mt-8 pt-6 border-t border-slate-800 flex flex-col items-center space-y-4">
            <a href="/admin/login" class="text-sm font-medium text-slate-400 hover:text-white transition">
            ...
            <a href="/register" class="text-sm font-medium text-emerald-500 hover:text-emerald-400 transition">
                Cadastrar
            </a>
        </div>
    </div>
